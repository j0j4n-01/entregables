import 'package:examenfluuter/Modelos/Peaje.dart';
...
class _EditarState extends State<Editar> {
  ...
  void initState() {
    ...
    // Setear valores iniciales del peaje seleccionado para edición
    _placaController.text = widget.peaje.placa;
    _selectedPeaje = widget.peaje.nombrePeaje;
    _selectedCategoria = widget.peaje.categoriaTarifaId;
    _fechaController.text =
        DateFormat('yyyy-MM-dd').format(widget.peaje.fechaRegistro);
    _observacionController.text = widget.peaje.observacion;
    ...
    if (_formKey.currentState!.validate() &&
      ...
      try {
        final response = await http.put(
          Uri.parse('http://localhost:5013/api/peaje/${widget.peaje.id}'),
        ...
        if (response.statusCode == 200) {
          ...
          ScaffoldMessenger.of(context)
              .showSnackBar(SnackBar(content: Text('Exito al Editar')));
        }
      } catch (e) {
